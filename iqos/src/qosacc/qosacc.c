 ...
 * qosacc - 基于netlink的QoS主动拥塞控制（支持HFSC/HTB/CAKE，含实时类检测）
...
/* ==================== 全局信号标志 ==================== */
static atomic_int g_sigterm_received = 0;
static atomic_int g_reset_bw = 0;

/* ==================== 帮助信息 ==================== */
const char qosacc_usage[] =
"qosacc - 基于ping延迟的动态QoS带宽调整器（支持实时类检测）\n"
"版本: 1.0.0\n\n"
"用法:\n"
