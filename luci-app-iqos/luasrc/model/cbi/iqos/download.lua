...
s.addremove = true
s.extedit = dsp.build_url("admin/qos/iqos/download/class/%s")
...
r.sortable  = true
r.extedit   = dsp.build_url("admin/qos/iqos/download/rule/%s")
...
function m.on_cancel(self)
    ...
    http.redirect(dsp.build_url("admin/qos/iqos"))
    return false
end
