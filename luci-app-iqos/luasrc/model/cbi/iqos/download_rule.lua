...
m = Map(iqos, translate("Edit Download Classification Rule"))
m.redirect = luci.dispatcher.build_url("admin/qos/iqos/download")

if m.uci:get(iqos, sid) ~= "download_rule" then
